...
const App = () => {
  ...
  const handleExport = useCallback((exportType) => {
    // ... (This function remains largely the same, but now it's just UI logic)
    // For brevity, the full implementation is omitted but should be copied from the previous version.
    // It relies on `logs`, `selectedTickets`, `selectedSessions`, `filteredAndGroupedLogs` which are all available here.
    setExportOption('');
